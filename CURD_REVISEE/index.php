...
<body>
    ...
    <header class="top-nav">
        <div class="nav-container">
            ...
            <div class="nav-right">
                <a href="dashboard.php" class="nav-crud-link">
                    <i class="fas fa-database"></i> ACCESS CRUD
                </a>
                <a href="#" class="nav-icon">
                    <i class="fas fa-th"></i>
                </a>
    ...
    <div class="main-container">
        ...
        <main class="main-content">
            <!-- CRUD Access Card - Prominent -->
            <div class="crud-access-card">
                <h2><i class="fas fa-database"></i> Employee Management System</h2>
                <p>Access the Employee CRUD dashboard to manage employee records, view reports, and perform administrative tasks.</p>
                <a href="dashboard.php" class="crud-access-btn">
                    <i class="fas fa-arrow-right"></i> ACCESS CRUD DASHBOARD
                </a>
            </div>
